            ...
            <div className="flex items-center justify-between">
              <div>
                <div className="flex items-center gap-3">
                  <CardTitle className="text-lg text-high-contrast">Auto-Enrollment #{enrollment.id.split('-')[2]}</CardTitle>
                  <Badge className={cn(
          ...
          <CardContent>
            <div className="p-4 rounded-xl bg-secondary border border-white/10">
              <div className="flex justify-between mb-2">
                <span className="text-sm text-medium-contrast">Daily Quantity:</span>
                <span className="text-sm font-medium text-high-contrast">{enrollment.dailyTickets} tickets</span>
              </div>
              <div className="flex justify-between mb-2">
                <span className="text-sm text-medium-contrast">Auto Enrollment Until:</span>
                <span className="text-sm font-medium text-high-contrast">{enrollment.endDate.toLocaleDateString()}</span>
              </div>
              <div className="flex justify-between mb-2">
                <span className="text-sm text-medium-contrast">Payment Method:</span>
                <span className="text-sm font-medium text-high-contrast">{enrollment.token}</span>
              </div>
              <div className="flex justify-between pt-2 border-t border-white/10">
                <span className="text-sm font-medium text-high-contrast">Next Purchase:</span>
