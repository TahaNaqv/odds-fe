    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-6 w-6 bg-transparent p-0 opacity-50 hover:opacity-100 flex items-center justify-center"
        ),
        nav_button_previous: "absolute left-0 inset-y-0",
        nav_button_next: "absolute right-0 inset-y-0",
      ...
      components={{
        IconLeft: ({ ..._props }) => <ChevronLeft className="h-3.5 w-3.5 pointer-events-auto ml-2.5" />,
        IconRight: ({ ..._props }) => <ChevronRight className="h-3.5 w-3.5 pointer-events-auto ml-2.5" />,
      }}
      {...props}
    />
  );
