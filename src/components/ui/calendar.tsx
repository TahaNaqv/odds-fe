  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav_button_previous: "absolute left-0 inset-y-0 flex items-center justify-center my-auto",
        nav_button_next: "absolute right-0 inset-y-0 flex items-center justify-center my-auto",
