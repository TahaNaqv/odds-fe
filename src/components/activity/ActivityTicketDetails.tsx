...
const ActivityTicketDetails = ({
  activities,
  date,
}: ActivityTicketDetailsProps) => {
  // Group by activity type
  const purchases = activities.filter(
  ...
  return (
    <div className="p-4">
      ...
      {wins.length > 0 && (
        <div className="mb-4">
          <h4 className="font-medium text-sm text-yellow-700 dark:text-yellow-300 mb-2">
            Winning Tickets
          </h4>
          {wins.map((win) => (
